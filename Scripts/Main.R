...
subtract <- Subtract(location, buffers)

### Make overlay and update data
all_size_locations <-overlayer(subtract, windspeeds)
...
### Write to shapefile
writeOGR(WGS_ideal_locations, ".", "data/final_result_WGS", driver="ESRI Shapefile")
